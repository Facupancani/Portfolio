...
export default function WorksShowcase() {
    ...
    // ----------------- Render -----------------
    return (
        <section id='projects' className="works h-[760vh]">
            <div className="works-wrapper h-auto w-full flex">
                ...
                <div className="works-display side-60 w-4/5 relative">
                    ...
                    {/* Thumbnails: ticker scroll según scroll real */}
                    ...
                    <div className="sticky top-10 z-20 flex flex-col justify-between h-screen p-8" style={{ width: '38vw' }}>
                        ...
                        <div>
                            <div className="flex items-center justify-between">
                                ...
                                {/* Número grande del proyecto activo */}
                        ...
                        <div className="flex flex-col mb-8">
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    if (link) window.open(link, "_blank"); // abre en nueva pestaña
                                }}
                            >
            ...
            {/* NOTA: agregá el CSS global que está al final de este archivo (comentado) a tu index.css o global.css */}
